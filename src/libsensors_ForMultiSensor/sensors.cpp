...
static const struct sensor_t sSensorList[] = {
        ...
        { "DMARD08 3-axis Accelerometer",
          "DMT",
          1, SENSORS_ACCELERATION_HANDLE,
          SENSOR_TYPE_ACCELEROMETER, (GRAVITY_EARTH * 3.0f),
		  (GRAVITY_EARTH) / 1024.0f, 0.25f, 10000, { } },
        { "AK8975 Orientation sensor",
          "Asahi Kasei Microdevices",
          1, SENSORS_ORIENTATION_HANDLE,
          SENSOR_TYPE_ORIENTATION, 360.0f,
        ...
        { "AK8975 Orientation sensor",
		  ...
		  CONVERT_O, 0.495f, 10000, { } },
#endif
#ifdef SENSORHAL_ACC_D18
        { "DMARD18 3-axis Accelerometer",
          "DMT",
          1, SENSORS_ACCELERATION_HANDLE,
          SENSOR_TYPE_ACCELEROMETER, (GRAVITY_EARTH * 3.0f),
		  (GRAVITY_EARTH) / 1024.0f, 0.25f, 10000, { } },
...
int sensors_poll_context_t::activate(int handle, int enabled) {
	...
	LOGD("activate handle=%d; drv=%d",handle, drv);
